        ...
        <div className="allshow-wrapper py-5 d-flex justify-content-center align-items-center" style={{ height: "90vh" }}>
          <div className="container">
            ...
            <div className="col-md-7">
              <div className="row">
                <div className="col">
                  <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Temporibus iste nostrum error dolore unde explicabo atque illo quae, corporis in nihil culpa doloribus! Quia doloribus totam ullam ratione vel ut possimus minus! Accusantium excepturi inventore animi soluta placeat, qui commodi iusto maiores dolores quam in sunt dolore, voluptatum eius non?</p>

                  <button className='btn btn-primary btn-lg'>Buy Ticket</button>
                </div>
              </div>
            </div>
          </div>
